...
| :--- | :--- | :--- | :--- | :--- |
| **Mahasiswa** | CSV (Synthetic) | 511 rows | **Moderate** (Bertambah setiap tahun ajaran baru) | **Semester** (Update status aktif/cuti/lulus) |
...
| **Akademik** | CSV (Synthetic) | 800 rows | **High** (Bertambah pesat tiap semester) | **Real-time** (Selama masa pengisian nilai) / Semester |
| **Publikasi Dosen** | CSV (Synthetic) | 800 rows | **Moderate** (Sesuai target kinerja tahunan) | **Annual** (Biasanya direkap akhir tahun/semester) |
